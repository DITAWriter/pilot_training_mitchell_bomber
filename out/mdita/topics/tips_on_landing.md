...
===============
 ...
 {.body .conbody}
A list of things to know that will make your landings easier on you and
on the [B-25]{.keyword}.
...
Hold the nose well up after landing. This reduces the length of the roll
considerably.

Excessive use of brakes is not necessary--- the rudders give ample
control.

Use the brakes in accordance with the amount of runway available.

The speed decreases considerably during the roll. Therefore, emergency
operations with the brakes can be delayed to prevent damage to the
airplane.

On slick runways the [B-25]{.keyword} is exceedingly difficult to
control. Land short, and slow the plane as much as possible without
brakes.
...
\
![](../images/cartoon-landing_crash.png){.image width="288"}\
